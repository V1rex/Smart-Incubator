...
class StartupProfileActivity : AppCompatActivity() {
    ...
    private fun show() {
        ...
        startup_description_profile.text = startup!!.mDescription

        var referrencePhoto : StorageReference = storageReference.child(REFERENCE_PROFILE_PHOTO + startup!!.mUserId)
